...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, MIN_ARW,  EQ_ARW, _______, _______, KC_PIPE, KC_DQUO, _______, _______, KC_LABK, KC_RABK, KC_QUES, KC_DEL, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, MIN_ARW,  EQ_ARW, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL,  \
